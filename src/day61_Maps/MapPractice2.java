...
public class MapPractice2 {
    ...
    public static void main(String[] args) {
      ...
      //  LinkedHashMap<String,Integer> angryBirds = new LinkedHashMap<>();//score<95
        ...
        for (String eachKeys :students.keySet()){
                Integer eachValue = students.get(eachKeys);
         /*
                if(eachValue>=95){
                    earlyBirds.put(eachKeys,eachValue);
                }else {
                    angryBirds.put(eachKeys,eachValue);
                }

          */
            if(eachValue >=90){
                earlyBirdsList.add(eachKeys);
            }
        }
