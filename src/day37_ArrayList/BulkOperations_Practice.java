...
public class BulkOperations_Practice {
    public static void main(String[] args) {
        ...
        //verify your mentor and one of your closet friend names are contained in the list
        ...
        employees.addAll(Arrays.asList("Ahmed","Muhtar","Ahmed","Virginia","Beslan","Imbrahim","Ahmed"));
