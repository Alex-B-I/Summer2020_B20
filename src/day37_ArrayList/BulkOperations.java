...
public class BulkOperations {
    ...
    // *.contains(); *.containsAll()______________________________
    public static void main(String[] args) {
        ...
        //Arrays.asList()___________________________________________
       ...
       //boolean r3 = list2.containsAll(Arrays.asList(10,20,4));
        ...
        System.out.println("============================");
        //*.addAll()______________________________________________
        ...
        System.out.println("============================");
        // *.removeAll___________________________________________

        ArrayList<Integer> nums =new ArrayList<>();
        nums.addAll(Arrays.asList(1,1,2,2,3,4,5,5,6,7,8,9,10,11,11,11,11,12,13));
        ...
        System.out.println("============================");
        // *.retainAll___________________________________________
