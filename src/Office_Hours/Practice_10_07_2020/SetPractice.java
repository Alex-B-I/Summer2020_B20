...
public class SetPractice {
    public static void main(String[] args) {
       ...
       // System.out.println(str.toUpperCase());
        ...
        String[] names = {"Dawud", "Selman","Aslan","Aslan","Aslan","Aslan","Aslan"};
        ...
        linkedHashSet.addAll(Arrays.asList(names)); // keep the insertion order as it is
        ...
        //System.out.println(hashSet.get(2)); // does not have get method
