...
public class CircleObjects {
    public static void main(String[] args) {
        ...
        System.out.println("Circle2 radius: "+ circle2.radius);//5.0
        System.out.println("Circle2 diameter: "+ circle2.diameter);//10.0
        ...
        System.out.println("Circle3 radius: "+ circle3.radius);//5.0
        System.out.println("Circle3 diameter: "+ circle3.diameter);//10.0
